...
/**
 * 此类由于使用Transactional注解，因此需要spring-tx jar包
...
public class CustomTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
	...
	/**
	 * Whether to reuse access tokens (until expired).
	 *
	 * @param reuseAccessToken Whether to reuse access tokens (until expired).
	 */
